                            ...
                            <div class="col-12">
                                ...
                                <div class="card">
                                    <div class="card-header">
                                        <h3 class="card-title">Placements List</h3>
                                        <div class="card-tools">
                                            <a href="<?= base_url('placements/new'); ?>" class="btn btn-primary btn-sm"><i class="fas fa-plus"></i> Add new</a>
                                        </div>
                                    </div>
                                    <div class="card-body">
                                        <table id="datatable" class="table table-bordered table-striped">
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <td><?= $obj->name; ?> <br> <?= $obj->comment; ?></td>
                                                    <td><?= $obj->company; ?></td>
                                                    <td><?= $obj->program; ?> <br> <?= $obj->batch; ?></td>
                                                    <td><?= date('jS M Y', strtotime($obj->created_on)); ?></td>
                                                    <td class="text-center">
                                                        <div class="btn-group">
                                                            <a href="<?= base_url('placements/delete/').$obj->id; ?>" type="button" class="btn btn-danger btn-sm">
