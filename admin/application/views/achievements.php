                                ...
                                <div class="card">
                                    <div class="card-header">
                                        ...
                                        <div class="card-tools">
                                            <a href="<?= base_url('achievements/new'); ?>" class="btn btn-primary btn-sm"><i class="fas fa-plus"></i> Add new</a>
                                        </div>
                                    </div>
                                    <div class="card-body">
                                        <table id="datatable" class="table table-bordered table-striped">
                                            ...
                                            <tbody>
                                                <?php $i = 1; foreach ($achievements as $key => $obj) { ?>
                                                <tr>
                                                    <td><?= $i; ?></td>
                                                    <td>
                                                    ...
                                                    <td class="text-center">
                                                        <div class="btn-group">
                                                            <a href="<?= base_url('achievements/delete/').$obj->id; ?>" type="button" class="btn btn-danger btn-sm">
