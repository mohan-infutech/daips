                        ...
                        <div class="row mb-2">
                            ...
                            <div class="col-sm-6">
                                <ol class="breadcrumb float-sm-right">
                                    ...
                                    <li class="breadcrumb-item"><a href="<?= base_url('notifications'); ?>">Notifications</a></li>
                    ...
                    <div class="container-fluid">
                        <div class="row">
                            <div class="col-6 mx-auto">
                                ...
                                <?php } ?>
                                <form action="<?= base_url('notifications/upload'); ?>" method="post" enctype="multipart/form-data">
                                <div class="card">
                                    <div class="card-header">
                                        <h6 class="text-center">Add New Notification</h6>
                                    </div>
                                    <div class="card-body">
