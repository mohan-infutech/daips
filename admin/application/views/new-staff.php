                    ...
                    <div class="container-fluid">
                        <div class="row">
                            <div class="col-6 mx-auto">
                                ...
                                <?php } ?>
                                <form action="<?= base_url('staffs/upload'); ?>" method="post" enctype="multipart/form-data">
                                <div class="card">
                                    <div class="card-header">
                                        <h6 class="text-center">Add New Staff</h6>
                                    </div>
                                    <div class="card-body">
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <div class="form-check form-check-inline">
                                                <input class="form-check-input" type="radio" name="type" id="teaching" value="teaching" checked>
                                                <label class="form-check-label" for="teaching">Teaching Staff</label>
                                            </div>
                                            <div class="form-check form-check-inline">
                                                <input class="form-check-input" type="radio" name="type" id="non-teaching" value="non-teaching">
                                        ...
                                        <div class="form-group">
                                            <label>About</label>
                                            <textarea name="about" rows="5" class="form-control" placeholder="Enter about"></textarea>
                                        </div>
                                    </div>
                                </div>
